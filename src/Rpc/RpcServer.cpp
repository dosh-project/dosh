...
bool RpcServer::f_on_get_blockchain_settings(const F_COMMAND_RPC_GET_BLOCKCHAIN_SETTINGS::request& req, F_COMMAND_RPC_GET_BLOCKCHAIN_SETTINGS::response& res) {
  res.base_coin.name = "dosh";
  res.base_coin.git = "https://github.com/doshproject/dosh.git";

  // Hardcoded plugins, refactor this
  res.extensions.push_back("core/dosh.json");
  ...
  res.core.DOSH_NETWORK = boost::lexical_cast<std::string>(m_p2p.get_network_id());
