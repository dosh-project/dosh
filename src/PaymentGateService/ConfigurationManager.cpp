...
po::variables_map confOptions;
  ...
  if (!(cmdOptions["DOSH_NETWORK"].as<std::string>().compare("11100111-1100-0101-1011-001210110110"))) {
    netNodeConfig.setNetworkId(boost::lexical_cast<boost::uuids::uuid>(confOptions["DOSH_NETWORK"].as<std::string>()));
  }
